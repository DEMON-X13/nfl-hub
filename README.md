...
| `nba-hub/` | NBA Hub: tonight's slate priced by a player-level Elo model (`index.html`, `admin.html`), the games table, box scores, both models and their daily job | see `nba-hub/README.md`; its own workflow, `.github/workflows/nba.yml`, runs every morning |
